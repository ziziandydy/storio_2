...
- [x] 6.3 更新 `docs/BACKLOG.md` 與 `docs/StorioWiki.md`（commit `8663cc5`）。CI 等效驗證：本地隔離 `.env` 跑後端 pytest 44 passed/2 skipped/0 failed（GitHub Actions 於 push/PR 時會依 `server/**` 異動自動再跑一次）
- [x] 6.4 openspec archive change（specs merge 回 openspec/specs/）
