    ...
    <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col items-center gap-4 bg-white/5 rounded-2xl p-6 border border-white/5">
            ...
            <span className="text-xs uppercase tracking-widest text-white font-bold h-4 transition-all duration-300">
                {hoverRating === 10 && "Masterpiece"}
                {hoverRating >= 8 && hoverRating < 10 && "Excellent"}
                {hoverRating >= 6 && hoverRating < 8 && "Very Good"}
                {hoverRating >= 4 && hoverRating < 6 && "Average"}
                {hoverRating >= 2 && hoverRating < 4 && "Poor"}
                {hoverRating === 1 && "Abysmal"}
        ...
        <div className="flex-grow relative">
                ...
                >
                    <div className="bg-accent-gold/10 px-4 py-2 flex items-center justify-between border-b border-accent-gold/10">
                        <span className="text-[9px] font-black uppercase tracking-widest text-accent-gold flex items-center gap-2">
                            <Wand2 size={12} /> AI Refined Proposal
                        </span>
            ...
            <div className="relative h-full">
                ...
                placeholder="What resonated with you? (Optional)"
                className="w-full h-48 bg-white/5 border border-white/10 rounded-xl p-4 text-sm text-white placeholder:text-white/20 focus:outline-none focus:border-accent-gold/50 focus:bg-white/10 transition-all resize-none leading-relaxed"
                />
        ...
        <div className="flex gap-3">
            ...
            >
                ...
                {isSaving ? "Saving..." : "Save to Storio"}
            </button>
        </div>
    </div>
  );
